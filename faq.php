            ...
            <div style="padding-bottom: 60px;">
                ...
                <div>
                    ...
                    <div class="row collapse" id="collapsedQuestion_2">
                        <div class="col-xs-12">
                            <p class="resp_faq">Os 193 países-membros das Nações Unidas adotaram oficialmente a nova agenda de desenvolvimento sustentável, intitulada “Transformando Nosso Mundo: A Agenda 2030 para o Desenvolvimento Sustentável”, na Cúpula de Desenvolvimento Sustentável, realizada na sede da ONU em Nova York, em setembro de 2015. Essa agenda contém 17 Objetivos e 169 metas.
                                <br/>
                    ...
                    <div class="row collapse" id="collapsedQuestion_3">
                        <div class="col-xs-12">
                            <p class="resp_faq">Os Objetivos de Desenvolvimento Sustentável (ODS) entraram em vigor em 1º de janeiro de 2016 e espera-se que sejam cumpridos até 31 de dezembro de 2030. Entretanto, há a expectativa de que algumas metas, baseadas em acordos internacionais, se cumpram antes do prazo estabelecido.</p>
                        </div>
                    </div>
                    <!-- ********* -->
                    ...
                    <div class="row collapse" id="collapsedQuestion_4">
                        <div class="col-xs-12">
                            <p class="resp_faq">Não. Os Objetivos de Desenvolvimento Sustentável (ODS) não são legalmente vinculantes. Entretanto, espera-se que os países se apropriem da agenda e estabeleçam um arcabouço nacional para alcançarem os 17 Objetivos. A implementação e o sucesso dependerão das políticas, planos e programas de desenvolvimento sustentável dos países. Os países têm a responsabilidade primária de acompanhar e revisar - a nível nacional, regional e global – os progressos feitos para a implementação dos Objetivos e metas nos próximos 15 anos. Ações em âmbito nacional para monitorar o progresso exigirão a pronta coleta de dados de qualidade e acessíveis, bem como acompanhamento e revisão em âmbito regional.</p>
                        </div>
                    </div>
                    <!-- ********* -->
                    ...
                    <div class="row collapse" id="collapsedQuestion_5">
                        <div class="col-xs-12">
                            <p class="resp_faq">Os Objetivos e metas estimularão as ações nos próximos 15 anos em áreas de fundamental importância: pessoas, planeta, prosperidade, paz e parceria.
                                <br/>
                                ...
                                <br/>
                                Parcerias – para mobilizar os meios necessários para a implementar esta Agenda por meio de uma Parceria Global para o Desenvolvimento Sustentável revitalizada, com base no espírito da solidariedade global fortalecida, com ênfase especial nas necessidades particulares dos mais pobres e mais vulneráveis, e com a participação de todos os países, todos os grupos interessados e todas as pessoas.</p>
                        </div>
                    </div>
                    <!-- ********* -->
                    ...
                    <div class="row collapse" id="collapsedQuestion_11">
                        <div class="col-xs-12">
                            <p class="resp_faq">Os Objetivos de Desenvolvimento do Milênio (ODM), lançados em 2000, estabeleceram 2015 como o ano-limite. A comunidade internacional começou a pensar, em 2010, em um arcabouço de trabalho para suceder os ODM.
                                <br/>
                    ...
                    <div class="row collapse" id="collapsedQuestion_14">
                        <div class="col-xs-12">
                            <p class="resp_faq">Os ODM produziram o mais bem-sucedido movimento de redução da pobreza da história e serviram como ponto de partida para a nova agenda de desenvolvimento sustentável.
                                <br/>
                                ...
                                <br/>
                                Parceria global: a assistência oficial ao desenvolvimento dos países desenvolvidos para países em desenvolvimento teve um aumento real de 66% do ano 2000 até 2014, chegando a U$ 135,2 bilhões.</p>
                        </div>
                    </div>
                    <!-- ********* -->
                    ...
                    <div class="row collapse" id="collapsedQuestion_15">
                        <div class="col-xs-12">
                            <p class="resp_faq">Cerca de 800 milhões de pessoas ainda vivem em situação de pobreza extrema, e 795 milhões ainda sofrem com a fome. Entre 2000 e 2015, o número de crianças fora da escola caiu quase pela metade. No entanto, ainda existem 57 milhões de crianças para as quais o direito à educação primária é negado.
                                <br/>
                    ...
                    <div class="row collapse" id="collapsedQuestion_16">
                        <div class="col-xs-12">
                            <p class="resp_faq">Fome e pobreza: as metas internacionais e nacionais foram alcançadas em 2012. A pobreza extrema caiu de 25%, em 1990, para 3%, em 2013.
                                <br/>
                                ...
                                <br/>
                                *Dados disponíveis no 5º Relatório Nacional de Acompanhamento dos Objetivos de Desenvolvimento do Milênio, publicado em 2014. [nota de rodapé da pergunta anterior]</p>
                        </div>
                    </div>
                    <!-- ********* -->
