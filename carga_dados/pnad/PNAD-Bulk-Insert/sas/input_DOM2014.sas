/*     PROGRAMA DE LEITURA EM SAS DO ARQUIVO DE MICRODADOS DE DOMICÍLIOS
    DA PNAD 2014 - PESQUISAS BÁSICA E SUPLEMENTARES DE ACESSO À INTERNET E À TELEVISÃO   
          E CADASTRO ÚNICO PARA PROGRAMA SOCIAL DO GOVERNO FEDERAL	*/

/* Obs.: As duas primeiras posições de V0102 (Número de controle)
        são o código da UF (Unidade da Federação).
   Obs.2: Ajuste o endereço do arquivo DOM2014.TXT no comando INFILE */


DATA DOM2014;
INFILE '...\dados\DOM2014.TXT' LRECL=220 MISSOVER;
INPUT 		@00001          V0101          $4.          /*Ano de referência*/
            ...
            @00209          V33001         $1.          /*Algum morador já ouviu falar sobre o Cadastro Único de Programas Sociais do Governo Federal*/
            @00210          V33002         $1.          /*Vocês conhecem ou já ouviram falar de programas do Governo Federal */			
            @00211          V33003         $1.          /*Vocês já tentaram fazer o cadastramento que dá acesso a um desses programas? */						
            @00212          V33004         $1.          /*Algum morador já foi entrevistado para o Cadastro Único que dá acesso a um desses programas? */						
			@00213          V9992          $8.          /*Data de geração do arquivo de microdados*/
			;
run;
